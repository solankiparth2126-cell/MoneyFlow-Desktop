...
public interface INavigationService
{
    ...
    void OpenStockItemList(IWin32Window? owner = null);
    void OpenUnitList(IWin32Window? owner = null);
    ...
    void OpenDebitNote(IWin32Window? owner = null);
    void OpenCreditNote(IWin32Window? owner = null);

    // Reports
    void OpenDashboard(IWin32Window? owner = null);
    void OpenDayBook(IWin32Window? owner = null);
    void OpenLedgerStatement(IWin32Window? owner = null, int? ledgerId = null);
    void OpenTrialBalance(IWin32Window? owner = null);
    ...
    void OpenOutstandingReport(IWin32Window? owner = null);
    void OpenStockSummary(IWin32Window? owner = null);
    ...
    void OpenSettings(IWin32Window? owner = null, Action? onSettingsSaved = null);
    void OpenDatabaseDiagnostics(IWin32Window? owner = null);
