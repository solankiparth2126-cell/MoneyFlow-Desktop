...
public class PurchaseVoucherForm : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        _lblVoucherNumber = new Label { Text = "PUR-00001", AutoSize = true, Anchor = AnchorStyles.Left, ForeColor = ExecLedgerTheme.PrimaryNavy, Font = ExecLedgerTheme.UIBold10 };
        ...
        pnlHeader.Controls.Add(new Label { Text = "Supplier A/c (Cr):", AutoSize = true, Anchor = AnchorStyles.Left, Font = ExecLedgerTheme.UIBold10 }, 0, 1);
        ...
        pnlHeader.Controls.Add(new Label { Text = "Purchase A/c:", AutoSize = true, Anchor = AnchorStyles.Left, Font = ExecLedgerTheme.UIBold10 }, 2, 1);
