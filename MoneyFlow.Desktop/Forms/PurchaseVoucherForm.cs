...
public class PurchaseVoucherForm : Form
{
    ...
    {
        Text = "Purchase Voucher (F9) — Invoice Entry (No GST)";
        ...
        // Row 0: Voucher No, Date, Supplier Invoice / Ref No
        ...
        _lblVoucherNumber = new Label { Text = "PUR-00001", AutoSize = true, Anchor = AnchorStyles.Left, ForeColor = Color.FromArgb(0, 51, 102), Font = new Font("Segoe UI", 10F, FontStyle.Bold) };
        ...
        pnlHeader.Controls.Add(new Label { Text = "Supplier Inv No:", AutoSize = true, Anchor = AnchorStyles.Left }, 4, 0);
        _txtRefNo = new TextBox { Width = 140, Font = new Font("Segoe UI", 9.5F) };
        pnlHeader.Controls.Add(_txtRefNo, 5, 0);

        // Row 1: Supplier / Party A/c (Credit) & Purchase Ledger (Debit)
        pnlHeader.Controls.Add(new Label { Text = "Supplier A/c (Cr):", AutoSize = true, Anchor = AnchorStyles.Left, Font = new Font("Segoe UI", 9.5F, FontStyle.Bold) }, 0, 1);
        ...
        pnlHeader.Controls.Add(new Label { Text = "Purchase A/c:", AutoSize = true, Anchor = AnchorStyles.Left, Font = new Font("Segoe UI", 9.5F, FontStyle.Bold) }, 2, 1);
        ...
        pnlHeader.Controls.Add(pnlPurchase, 3, 1);
        ...
        _btnPrint.Click += (s, e) => MessageBox.Show("Purchase voucher print preview will be configured with RDLC reports in Phase 33.", "Print Voucher", MessageBoxButtons.OK, MessageBoxIcon.Information);
    ...
    {
        if (_purchaseVoucherType == null || _companyContext.CurrentCompany == null || _companyContext.CurrentFinancialYear == null)
            return;
    ...
    private async Task SaveVoucherAsync(bool closeAfterSave)
    {
        try
        {
            ...
            // 1. Debit: Purchase Account for Net Total
            // 2. Credit: Supplier Party Account for Net Total
