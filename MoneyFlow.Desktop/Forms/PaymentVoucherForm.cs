...
public class PaymentVoucherForm : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        _lblVoucherNumber = new Label { Text = "PAY-00001", AutoSize = true, Anchor = AnchorStyles.Left, ForeColor = Color.FromArgb(0, 51, 102), Font = new Font("Segoe UI", 10F, FontStyle.Bold) };
        ...
        // Row 1: Source Account (Credit: Cash/Bank)
        pnlHeader.Controls.Add(new Label { Text = "Account (Cr):", AutoSize = true, Anchor = AnchorStyles.Left, Font = new Font("Segoe UI", 9.5F, FontStyle.Bold) }, 0, 1);
        ...
        // 2. DataGridView for Line Items (Debit entries)
        ...
        {
            HeaderText = "Particulars (Debit A/c)",
            Name = "ColLedger",
            Width = 350,
    ...
    private async Task OnFormLoadAsync()
    {
        ...
        try
        {
            ...
            // Load all ledgers for line items (Particulars)
    ...
    private async Task UpdateVoucherNumberPreviewAsync()
    {
        ...
        {
            _lblVoucherNumber.Text = "PAY-00001";
        }
    }
    ...
    private async Task OnGridCellValueChangedAsync(int rowIndex, int columnIndex)
    {
        ...
        // If Ledger changed, update Current Balance column
        ...
        // If Amount changed, recalculate totals
    ...
    private void RecalculateTotals()
    {
        ...
        _lblTotalAmount.Text = $"Total Amount: ₹{totalDebit:N2}";
    ...
    private async Task OnSaveVoucherAsync(bool closeOnSuccess)
    {
        ...
        {
            MessageBox.Show("Please select a valid Cash/Bank credit account.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            _cmbAccount.Focus();
            return;
        }

        // Collect Debit line entries from DataGridView
        ...
        // Add matching Credit entry for the Cash/Bank account
        entries.Add(new VoucherEntryDto
        {
